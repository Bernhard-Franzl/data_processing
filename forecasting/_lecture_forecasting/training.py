...
class MasterTrainerLecture:
    ...
    def handle_model_class(self, model_class:str):
        ...
        if model_class == "simple_lecture_lstm":
    ...
    def initialize_dataloader(self, train_set:Dataset, val_set:Dataset, test_set:Dataset, dataset_mode:str):
        ...
        train_loader = DataLoader(train_set, batch_size=self.hyperparameters["batch_size"], shuffle=True, 
                                  collate_fn=collate_f, generator=self.torch_rng)
